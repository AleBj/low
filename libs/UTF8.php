...
class UTF8
{
   ...
   */
  public static function access(string $str, int $pos)
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function add_bom_to_string(string $str)
  {
   ...
   * @return array
   */
  public static function callback($callback, string $str)
  {
   ...
   */
  public static function chr_map($callback, string $str)
  {
   ...
   */
  public static function chr_size_list(string $str)
  {
    if (!isset($str[0])) {
      return array();
    }
   ...
   * @return int
   */
  public static function chr_to_decimal(string $char)
  {
   ...
   */
  public static function chr_to_hex(string $char, $pfix = 'U+')
  {
    if (!isset($char[0])) {
      return '';
    }
   ...
   * @return int
   */
  public static function chr_to_int(string $chr)
  {
   ...
   */
  public static function isBom($utf8_chr)//: bool
  {
   ...
   */
  public static function isHtml($str)//: bool
  {
   ...
   * @return boolean
   */
  public static function is_html($str)//: bool
  {
    if (!isset($str[0])) {
      return false;
    }
   ...
   * @return bool
   */
  public static function is_utf8($str, $strict = false)//: bool
  {
    if (is_array($str) === true) {
      foreach ($str as $k => $v) {
   ...
   */
  public static function lcfirst($str, $encoding = 'UTF-8', $cleanUtf8 = false)//: string
  {
   ...
   * @return string
   */
  public static function lcword($word, $encoding = 'UTF-8', $cleanUtf8 = false)//: string
  {
   ...
   * @return string
   */
  public static function lcwords($str, array $exceptions = array(), $charlist = '', $encoding = 'UTF-8', $cleanUtf8 = false)//: string
  {
    if (!$str) {
      return '';
    }
   ...
   */
  public static function ltrim($str = '', $chars = INF)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function max_chr_width($str)//: int
  {
   ...
   * @return string
   */
  public static function normalize_msword($str)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return string
   */
  public static function normalize_whitespace($str, $keepNonBreakingSpace = false, $keepBidiUnicodeControls = false)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return string
   */
  public static function strip_whitespace($str)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   *             </p>
   */
  public static function ord($chr, $encoding = 'UTF-8')//: int
  {
    // init
    static $CHAR_CACHE = array();
   ...
   */
  public static function parse_str($str, &$result, $cleanUtf8 = false)//: bool
  {
    if ($cleanUtf8 === true) {
      $str = self::clean($str);
    }
   ...
   * @return string
   */
  public static function rawurldecode($str, $multi_decode = true)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function removeBOM($str)//: string
  {
   ...
   */
  public static function remove_bom($str)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function remove_duplicates($str, $what = ' ')//: string
  {
   ...
   * @return string
   */
  public static function remove_invisible_characters($str, $url_encoded = true, $replacement = '')//: string
  {
    // init
   ...
   * @return string
   */
  public static function replace_diamond_question_mark($str, $replacementChar = '', $processInvalidUtf8 = true)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function rtrim($str = '', $chars = INF)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return string
   */
  private static function rxClass($s, $class = '')//: string
  {
   ...
   */
  public static function single_chr_html_encode($char, $keepAsciiChars = false, $encoding = 'UTF-8')//: string
  {
    if (!isset($char[0])) {
      return '';
    }
   ...
   */
  public static function split($str, $length = 1, $cleanUtf8 = false)//: array
  {
    if (!isset($str[0])) {
      return array();
    }
   ...
   * @return bool
   */
  public static function str_iends_with($haystack, $needle)//: bool
  {
    if (!isset($haystack[0], $needle[0])) {
      return false;
    }
   ...
   * @return bool
   */
  public static function str_istarts_with($haystack, $needle)//: bool
  {
    if (!isset($haystack[0], $needle[0])) {
      return false;
    }
   ...
   * @return string
   */
  public static function str_limit_after_word($str, $length = 100, $strAddOn = '…')//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function str_pad($str, $pad_length, $pad_string = ' ', $pad_type = STR_PAD_RIGHT)//: string
  {
   ...
   */
  public static function str_repeat($str, $multiplier)//: string
  {
    $str = self::filter($str);
   ...
   * @return string
   */
  public static function str_replace_first($search, $replace, $subject)//: string
  {
   ...
   */
  public static function str_sort($str, $unique = false, $desc = false)//: string
  {
   ...
   * @return array
   */
  public static function str_split($str, $len = 1)//: array
  {
    if (is_array($str) === true) {
      foreach ($str as $k => $v) {
   ...
   * @return string
   */
  public static function str_to_binary($str)//: string
  {
    $value = unpack('H*', $str);
   ...
   * @return array
   */
  public static function str_to_words($str, $charList = '', $removeEmptyValues = false, $removeShortValues = null)//: array
  {
    if (!isset($str[0])) {
   ...
   * @return string
   */
  public static function str_transliterate($str, $unknown = '?', $strict = false)//: string
  {
   ...
   *              </p>
   */
  public static function strcmp($str1, $str2)//: int
  {
    /** @noinspection PhpUndefinedClassInspection */
   ...
   */
  public static function string_has_bom($str)//: bool
  {
    foreach (self::$BOM as $bomString => $bomByteLength) {
   ...
   */
  public static function strip_tags($str, $allowable_tags = null, $cleanUtf8 = false)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function strlen($str, $encoding = 'UTF-8', $cleanUtf8 = false)//: int
  {
    if (!isset($str[0])) {
      return 0;
    }
   ...
   *             <strong>0</strong> if they are equal
   */
  public static function strnatcasecmp($str1, $str2)//: int
  {
   ...
   *             <strong>0</strong> if they are equal
   */
  public static function strnatcmp($str1, $str2)//: int
  {
   ...
   *             <strong>0</strong> if they are equal
   */
  public static function strncasecmp($str1, $str2, int $len)//: int
  {
   ...
   *             <strong>0</strong> if they are equal
   */
  public static function strncmp($str1, $str2, int $len)//: int
  {
   ...
   */
  public static function strrev($str)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return int
   */
  public static function strspn($str, $mask, $offset = 0, $length = null)//: int
  {
    if ($offset || $length !== null) {
      $strTmp = self::substr($str, $offset, $length);
      if ($strTmp === false) {
   ...
   * @return string
   */
  public static function strtocasefold($str, $full = true, $cleanUtf8 = false)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function strtolower($str, $encoding = 'UTF-8', $cleanUtf8 = false, $lang = null)//: string
  {
    // init
    $str = (string)$str;
    if (!isset($str[0])) {
   ...
   */
  public static function strtoupper($str, $encoding = 'UTF-8', $cleanUtf8 = false, $lang = null)//: string
  {
    $str = (string)$str;
    if (!isset($str[0])) {
      return '';
   ...
   *                </p>
   */
  public static function strtr($str, $from, $to = INF)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return int
   */
  public static function strwidth($str, $encoding = 'UTF-8', $cleanUtf8 = false)//: int
  {
    if ($encoding !== 'UTF-8') {
      $encoding = self::normalize_encoding($encoding, 'UTF-8');
    }
   ...
   */
  public static function array_change_key_case(array $array, $case = CASE_LOWER)//: array
  {
    if (
        $case !== CASE_LOWER
        &&
  ...
  public static function substr($str, $offset = 0, $length = null, $encoding = 'UTF-8', $cleanUtf8 = false)
  {
    ...
    if (
      ...
      return substr($str, $offset, isset($length) ? $length : $str_length);
    }
   ...
   *             </p>
   */
  public static function substr_compare($str1, $str2, $offset = 0, $length = null, $case_insensitivity = false)//: int
  {
    if (
        $offset !== 0
        ||
   ...
   */
  public static function substr_ileft($haystack, $needle)//: string
  {
    if (!isset($haystack[0])) {
      return '';
    }
   ...
   * @return string <p>Return the sub-string.</p>
   */
  public static function substr_iright($haystack, $needle)//: string
  {
    if (!isset($haystack[0])) {
      return '';
    }
   ...
   * @return string <p>Return the sub-string.</p>
   */
  public static function substr_left($haystack, $needle)//: string
  {
    if (!isset($haystack[0])) {
      return '';
    }
  ...
  public static function substr_replace($str, $replacement, $offset, $length = null)
  {
    if (is_array($str) === true) {
      ...
      // recursive call
      return array_map(array(self::$this, 'substr_replace'), $str, $replacement, $offset, $length);
    }
   ...
   * @return string <p>Return the sub-string.</p>
   */
  public static function substr_right($haystack, $needle)//: string
  {
    if (!isset($haystack[0])) {
      return '';
    }
   ...
   */
  public static function swapCase($str, $encoding = 'UTF-8', $cleanUtf8 = false)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function toAscii($str, $subst_chr = '?', $strict = false)//: string
  {
   ...
   * @return string
   */
  public static function to_ascii($str, $unknown = '?', $strict = false)//: string
  {
   ...
   */
  public static function trim($str = '', $chars = INF)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return string <p>The resulting string</p>
   */
  public static function ucfirst($str, $encoding = 'UTF-8', $cleanUtf8 = false)//: string
  {
    if ($cleanUtf8 === true) {
      // "\mb_strpos" and "\iconv_strpos" returns wrong position,
      // if invalid characters are found in $haystack before $needle
   ...
   * @return string
   */
  public static function ucword($word, $encoding = 'UTF-8', $cleanUtf8 = false)//: string
  {
   ...
   * @return string
   */
  public static function ucwords($str, $exceptions = array(), $charlist = '', $encoding = 'UTF-8', $cleanUtf8 = false)//: string
  {
    if (!$str) {
      return '';
    }
   ...
   * @return string
   */
  public static function urldecode($str, $multi_decode = true)// string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return string
   */
  public static function utf8_decode($str, $keepUtf8Chars = false)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   * @return string
   */
  public static function utf8_encode($str)//: string
  {
    if (!isset($str[0])) {
      return '';
    }
   ...
   */
  public static function utf8_fix_win1252_chars($str)//: string
  {
   ...
   * @return string
   */
  public static function words_limit(string $str, $limit = 100, $strAddOn = '…')//: string
  {
    if (!isset($str[0])) {
      return '';
    }
