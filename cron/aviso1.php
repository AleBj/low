...
class trabajosBase
{
    ...
    public function traerForms()
    {
        $_data = self::con()->prepare("SELECT cfr.* FROM `contenidos_forms_respuestas` as cfr
                                                        ...
                                                        NOW() >= cfr.fecha_aviso_1 AND NOW() < cfr.fecha_aviso_2
                                                        ORDER BY cfr.id ASC");
        $_data->execute();
    ...
    {
        $_id = (int) $_id;
        $_data = self::con()->prepare("SELECT cfa.* FROM `contenidos_forms_avisos_uno` as cfa WHERE cfa.id_form = :id");
    ...
    {
        $_id = (int) $_id;
        $_data = self::con()->prepare("INSERT INTO `contenidos_forms_avisos_uno` (id_form,fecha) VALUES (:id,:fecha)");
                    ...
                    <body style="margin: auto;width: 50%;padding:0;box-sizing: border-box;min-width: 600px;font-family:Arial, Helvetica, sans-serif;;color: #000;">
                       ...
                       <div class="container" style="background-color: #f2f0e2; padding: 0 50px;">
                            ...
                            <div class="intro-text" >
                                ...
                                <p class="text-small" >Thank you for choosing us to support you in this important transition. We are almost at the six-month mark and need your paperwork finalized for filing. Please complete your interview <a href="'.BASE.'user/myorders">here</a>.</p>
