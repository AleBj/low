...
class termsandconditionsController extends Controller
{
	...
	{		
		$this->_view->data = $this->homeGestion->traerTermsandconditions();

		// SEO
        $this->_view->seo = $this->homeGestion->traerSeoSeccion('termsandconditions', 'seccion');
		...
		// $this->_view->titulo = 'Terms and Conditions';   
        $this->_view->renderizar('index', 'termsandconditions', 'default');
