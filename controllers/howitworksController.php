...
class howitworksController extends Controller
{
	...
	{		
		$this->_view->data = $this->homeGestion->traerHowItWorks();


		// SEO
        $this->_view->seo = $this->homeGestion->traerSeoSeccion('howitworks', 'seccion');
		...
		// $this->_view->titulo = 'How it Works';   
        $this->_view->renderizar('index', 'howitworks', 'default');
