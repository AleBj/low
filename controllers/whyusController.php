...
class whyusController extends Controller
{
	...
	{		
		$this->_view->data = $this->homeGestion->traerWhyUs();

		// SEO
        $this->_view->seo = $this->homeGestion->traerSeoSeccion('whyus', 'seccion');
		...
		// $this->_view->titulo = 'Why us';   
        $this->_view->renderizar('index', 'whyus', 'default');
