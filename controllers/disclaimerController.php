...
class disclaimerController extends Controller
{
	...
	{		
		$this->_view->data = $this->homeGestion->traerDisclaimer();

		// SEO
        $this->_view->seo = $this->homeGestion->traerSeoSeccion('disclaimer', 'seccion');
		...
		// $this->_view->titulo = 'Disclaimer';   
        $this->_view->renderizar('index', 'disclaimer', 'default');
