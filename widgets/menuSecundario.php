...
class menuSecundarioWidget extends Widget
{
	private $_registro;
	private $_sess;
    private $modelo;
    ...
    public function __construct(){
        ...
        $this->modelo = $this->loadModel('menuSecundario');
    }
    ...
    public function getMenu($item = false)
    {
        ...
        $data['menuSecundario'] = $this->modelo->getMenu($item);
        return $this->render('menu-secundario', $data);
    }
