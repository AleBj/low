...
class menuPrimarioModelWidget
{
    ...
    {
		//$this->_gestion_menu->crearCache('primario', Registro::tomarInstancia()->_conf['base_url'], Registro::tomarInstancia()->_conf['ruta_cache']['widgets']['menus']);
